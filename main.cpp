...
GLfloat LightColor[][3]={0,0,1, 0,1,1, 0,0,0};
...
GLfloat ALienBeak[][2]={{-6,30.5}, {-6.5,26}, {-9,23}, {-11,22.5}, {-20,25}, {-14,26}, {-9.5,28}, {-7,27}, {-6,26.5},
...
void introScreen()
{
	glClear(GL_COLOR_BUFFER_BIT);
		...
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-425, 490, 0.0,"BLDEA'S DR PG HALAKATTI COLLEGE OF ENGINEERINGN AND TECHNOLOGY");
	...
	displayRasterText(-100, 150, 0.0,"created by");
	 ...
	 displayRasterText(-130, 80, 0.0,"SHOOTERS");
	  ...
	  displayRasterText(-800, -100, 0.0," STUDENT NAMES");
	  	glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-800, -200, 0.0," Megha Savalagi");
	displayRasterText(-800, -285, 0.0," Laxmi Kumbar");
	displayRasterText(-800, -370, 0.0," Madhu Biradar");
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(500, -100, 0.0,"Under the Guidance of");
		glColor3f(1.0, 1.0, 1.0);
	displayRasterText(500, -200, 0.0,"Prof S.S.Devar");
		glColor3f(1.0, 0.0, 0.0);
